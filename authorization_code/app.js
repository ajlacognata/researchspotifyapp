...
var spotifyApi = new SpotifyWebApi({
  ...
  redirectUri: 'http://www.anthonylacognataresearch.com/callback'
});
...
var redirect_uri = 'http://www.anthonylacognataresearch.com/callback'; // Your redirect uri
  ...
  if (state === null || state !== storedState) {
    ...
    request.post(authOptions, function(error, response, body) {
      ...
      .then(function(data) {
        ...
        fs.writeFileSync('spotifyData' +counter +'.json', jsonString, function(err) {console.log('Something went wrong!', err)});
